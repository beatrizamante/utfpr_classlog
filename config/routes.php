...
Route::middleware('auth')->group(function () {
  ...
  Route::get('/schedules/exceptions', [SchedulesExceptionController::class, 'index'])->name('schedules.exceptions.index');
  Route::post('/schedules/exceptions', [SchedulesExceptionController::class, 'create'])->name('schedules.exceptions.create');
